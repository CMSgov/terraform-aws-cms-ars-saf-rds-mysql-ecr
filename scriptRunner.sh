...
if [[ -n $s3_bucket_path ]]; then
    ...
    cinc-auditor exec /home/default/profiles/cms-ars-3.1-moderate-aws-rds-oracle-mysql-ee-5.7-cis-overlay --input-file=/home/default/profiles/cms-ars-3.1-moderate-aws-rds-oracle-mysql-ee-5.7-cis-overlay/inputs.yml --reporter json --target aws:// --chef-license accept-silent | aws s3 cp - "$s3_bucket_path/$filename"
